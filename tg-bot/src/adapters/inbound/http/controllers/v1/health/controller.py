...
class HealthController:
    health_check_use_case: HealthCheckUseCase = Depends(Dependencies.health_check_use_case)
    ...
    async def get_liveness_status(self) -> LivenessResponseSchema:
        """
    ...
    async def get_readiness_status(self, response: Response) -> ReadinessResponseSchema:
        """
        ...
        """
        health_domain = await self.health_check_use_case.get_health_status()
